...
@section('content')
 <link href="https://cdn.datatables.net/1.10.19/css/dataTables.bootstrap4.min.css" rel="stylesheet">
        ...
        <div class="page-header page-header-default">
          <div class="page-header-content">
            <div class="page-title">
              <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Fees Module</span> ->Master->Fee Head Setup</h4>
            </div>
          </div>
      </div>
        <!-- /page header -->
           ...
           <!-- Vertical form options -->
              <div class="panel panel-flat">
                  <div class="panel-heading">
                    @can('fee-head-setup-create')
                        <button type="button" id='openModal' class="btn btn-primary btn-sm" >New Fee Head Setup<i class="icon-plus-circle2 position-right"></i></button>
                    @endcan
        ...
        @include('backend.feeheadsetup.create')
        @include('backend.feeheadsetup.edit')
@endsection
@section('script')   
        ...
        $(document).ready(function() {
            ...
            function listdata(){ 
                    ...
                    "stripeClasses": [ 'odd-row', 'even-row' ],
                       processing: true,
                       serverSide: true,
                       ajax: "{{ url('feeheadsetupdatatable') }}",
                       columns: [
                                { data: 'id', name: 'id' , orderable: false, searchable: false},
                                { data: 'fee_head_name', name: 'fee_head_name' },
                                { data: 'is_compulsory', name: 'is_compulsory' },
