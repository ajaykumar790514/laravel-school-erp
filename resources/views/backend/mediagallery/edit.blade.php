...
<link href="https://unpkg.com/filepond-plugin-image-preview/dist/filepond-plugin-image-preview.css" rel="stylesheet"/>
	...
	<div class="content">
			...
			<form class="form-horizontal" method="POST" action='{{ url("health-services-edit/{$id}")}}' enctype="multipart/form-data">
		      {{ csrf_field() }}
		      <div class="row">
		          @include('layouts.massage') 
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12">
								        ...
								        <div class="form-group{{ $errors->has('short_description') ? ' has-error' : '' }}">
    										...
    										<textarea row='5' call='5' class="form-control" id='short_description' name='short_description' placeholder="Enter your description here">{{ $data->short_description}}</textarea>
									    </div>
                       ...
                       <div class="panel panel-white">
								...
								<div class="panel-body">
									<button type="submit" class="btn btn-primary"> <i class=" icon-floppy-disk position-centre"></i> Save</button>
									  @can('health-services-list')
                                        <a href="{{ url('health-services-list')}}" class="btn btn-default "> <i class="icon-arrow-left52 position-centre"></i> Back to Image Gallery List</a>
                                    @endcan
								</div>
							</div>
                    </div>
                    ...
                    <div class="col-md-4">
                       <div class="panel panel-white">
								<div class="panel-heading">
									<h6 class="panel-title">Icon<span class="text-danger">*</span><a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
								</div>
								<div class="panel-body">
								    <div class="form-group{{ $errors->has('icon_image') ? ' has-error' : '' }}">
                                        ...
                                        data-max-file-size="3MB"
                                        data-max-files="1">
                                        <span id='displayImg'><img src='{{  asset($data->icon_image)}}' width='150'></span>
								    </div>
							    </div>
                    </div>
                </div>
 ...
 <script type="text/javascript">  
       ...
       $(document).ready(function () {
            CKEDITOR.replace( 'description', {
             ...
             const inputElement = document.querySelector('input[id="icon_image"]');
                FilePond.create(inputElement, {
                server:{
                    url: '/healthserviceIcon',
                    headers: {
