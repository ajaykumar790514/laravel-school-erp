...
<link href="https://unpkg.com/filepond-plugin-image-preview/dist/filepond-plugin-image-preview.css" rel="stylesheet"/>
        ...
        <div class="content">
            <!-- 2 columns form -->
            <form class="" method="POST" action="{{ url('media-category-create')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group{{ $errors->has('parent_id ') ? ' has-error' : '' }}">
                                                    ...
                                                    <select name="parent_id" id="parent_id" class="form-control select">
                                                        ...
                                                        @foreach ($category->children as $childCategory)
                                                                    @include('backend.mediacategories.child_category', ['child_category' => $childCategory])
                                                                @endforeach
                                                        @endforeach
                                                ...
                                                <div class="form-group{{ $errors->has('short_description') ? ' has-error' : '' }}">
                                                    <label>Description</label>
                                                    	<textarea rows="5" cols="5" class="form-control" id='short_description' name='short_description' placeholder="Enter your meta description here">{{ old('short_description')}}</textarea>
