...
@section('content')
          ...
          <div class="page-header-content">
            <div class="page-title">
              <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Admission</span> ->Master->Create New Subject Setup</h4>
            </div>
          </div>
                ...
                <div class="content">
                    <!-- 2 columns form -->
                    <form class="" method="POST" action="{{ url('subjectssetup-create')}}" enctype="multipart/form-data">
                       {{ csrf_field() }}
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <select id="parent_id"  class="select" name="parent_id" >
                                                ...
                                                {{App\Models\SubjectSetups::getSubSubject('0', '', old('parent_id'))}} 
                                        ...
                                        <div class="form-group{{ $errors->has('subject_initial') ? ' has-error' : '' }}">
                                            ...
                                            <input type="Year" class="form-control" name='subject_initial', placeholder="Hindi" id='subject_initial'  value="{{ old('subject_initial')  }}">
                                           
                                        </div>
                                        <div class="form-group{{ $errors->has('subject_name') ? ' has-error' : '' }}">
                                            <label>Subject Name <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name='subject_name', placeholder="Hindi" id='subject_name'  value="{{ old('subject_name') }}">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <select id="subject_type"  class="form-control" name="subject_type" >
                                                ...
                                                <option value='2' {{old('subject_type')==2?"selected":""}}>Both</option>
                                            </select>
                                            ...
                                            <select id="subject_mode"  class="form-control" name="subject_mode" >
                                                <option value=''>--Select--</option>
                                                <option value='0' {{ old('subject_mode')==0?"selected":""}}>Compulsory</option>   
                                                <option value='1' {{old('subject_mode')==1?"selected":""}}>Optional</option>
                                            </select>
                                           </div>
                                ...
                                <div class="text-right">
                                    <button type="submit" class="btn btn-primary"><i class="icon-add position-left"></i> Save New Subject </button>
                                </div>
                            </div>
                        </div>
                    </form>
