        ...
        <div class="page-header page-header-default">
          <div class="page-header-content">
            <div class="page-title">
              <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Admission</span> ->Master->Subject Setup</h4>
            </div>
         </div>
           ...
           <!-- Vertical form options -->
              <div class="panel panel-flat">
                  ...
                  <div class="panel-heading">
                    @can('subjectssetup-create')
                   <a href="{{ url('subjectssetup-create')}}" class="btn btn-primary"><i class="icon-calendar position-left"></i>New Subject Setup</a>
                    @endcan
...
<script>
        ...
        "stripeClasses": [ 'odd-row', 'even-row' ],
           ...
           ajax: "{{ url('subjectsetupdatatable') }}",
           columns: [
                    { data: 'id', name: 'id', orderable:false, searchable:false },
                    { data: 'parent_id', name: 'parent_id' },
                    { data: 'subject_initial', name: 'subject_initial' },
                    { data: 'subject_name', name: 'subject_name' },
                    { data: 'subject_type', name: 'subject_type' },
                    { data: 'subject_mode', name: 'subject_mode' },
