...
@section('content')
    ...
    <div class="page-header page-header-default">
                  <div class="page-header-content">
                    <div class="page-title">
                      <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Employee</span> -Edit Designation Setup Details</h4>
                    </div>
                  </div>
                 </div>
    <!-- /page header -->
    ...
    <div class="content">
                    ...
                    <form class="" method="POST" action='{{ url("designation-edit/{$id}") }}' enctype="multipart/form-data">
                       {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <input type="Year" class="form-control" name='designation_name', id='designation_name'  value="{{ $data->designation_name}}">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <fieldset>
                                           <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                            ...
                                            <textarea rows="4" class="form-control" name='description', id='description'>{{ $data->description  }} </textarea>
                                         </div>
