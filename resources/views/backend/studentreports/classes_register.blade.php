        ...
        <div class="page-header page-header-default">
          <div class="page-header-content">
            <div class="page-title">
              <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Reports</span> ->Classes Register</h4>
            </div>
          </div>
      </div>
        <!-- /page header -->
                  ...
                  <div class="panel-heading">
                    <div class="heading-elements">
                      <ul class="icons-list">
                            ...
                            <a href='{{ url("export-student-all-data")}}' class="btn btn-primary"></i>Download All Student Data</a>
                    </div>
                                            ...
                                            <tr role="row">
                                               ...
                                               <td>
                                                <?php
                                                  ...
                                                  $classSetupId=base64_encode($classDetails->classsetup_id);
                                                  $sectionId=base64_encode($classDetails->sectionId);
                                                ?>
                                                <a href='{{ url("student-register/{$sessionId}/{$classSetupId}/{$sectionId}")}}'><i class="icon-magazine"></i> Register</a></td>
                                            </tr>
                                          <?php $i++;?>
                                          @endforeach
