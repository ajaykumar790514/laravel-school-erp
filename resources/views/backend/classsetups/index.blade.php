        ...
        <div class="page-header page-header-default">
          <div class="page-header-content">
            <div class="page-title">
              <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Admission</span> ->Master->Class Setup</h4>
            </div>
          </div>
      </div>
        <!-- /page header -->
           ...
           <!-- Vertical form options -->
              <div class="panel panel-flat">
                  <div class="panel-heading">
                    @can('classsetup-create')
                   <a href="{{ url('classsetup-create')}}" class="btn btn-primary"><i class=" icon-office position-left"></i>New Class Setup</a>
                    @endcan
        ...
        $(document).ready(function() {
            ...
            function listdata(){ 
                    ...
                    "stripeClasses": [ 'odd-row', 'even-row' ],
                       processing: true,
                       serverSide: true,
                       ajax: "{{ url('classsetupdatatable') }}",
                       columns: [
                                { data: 'id', name: 'id'},
                                { data: 'class_name', name: 'class_name' },
                                { data: 'class_strength', name: 'class_strength' },
