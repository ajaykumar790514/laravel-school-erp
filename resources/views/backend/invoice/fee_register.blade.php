                ...
                <div class="page-header page-header-default">
                      <div class="page-header-content">
                        <div class="page-title">
                          <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Fee Madule</span>->Reports->Fee Register</h4>
                        </div>
                      </div>
                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-heading">
                            @can('fee-invoice-list')
                           <a href="{{ url('fee-invoice-list')}}" class="btn btn-primary"><i class=" icon-office position-left"></i>Fee Collection Invoice</a>
                            @endcan
                            <h6>Transactions List ({{count($data)}})</h6>
                                                ...
                                                <li class="dropdown">
                                                	...
                                                	<ul class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        @if($dataDetails->status==0)
                                                            <li><a href='{{url("removeInvoice/{$dataDetails->invoice_no}")}}' onclick="return confirm('Are you sure?');" class='delete'><i class=' icon-cancel-circle2'></i> Move to trash</a></li>
                                                		@endif
                                                	</ul>
                                                    </li>
                                                </ul> 
