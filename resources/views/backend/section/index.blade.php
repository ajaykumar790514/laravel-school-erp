        ...
        <div class="page-header page-header-default">
          <div class="page-header-content">
            <div class="page-title">
              <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Admission</span> ->Master->Section Setup</h4>
            </div>
          </div>
      </div>
        <!-- /page header -->
           ...
           <!-- Vertical form options -->
              <div class="panel panel-flat">
                  <div class="panel-heading">
                    @can('sectionsetup-create')
                   <a href="{{ url('sectionsetup-create')}}" class="btn btn-primary"><i class=" icon-office position-left"></i>New Section Setup</a>
                    @endcan
...
<script>
        ...
        "stripeClasses": [ 'odd-row', 'even-row' ],
           ...
           ajax: "{{ url('sectionsetupdatatable') }}",
           columns: [
                    { data: 'id', name: 'id' },
